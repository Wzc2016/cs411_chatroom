...
io.on('connection', function(socket) {
  ...
  socket.on('login', function(obj) {
    ...
    console.log(obj.username + 'join the chatroom');
  });
  ...
  socket.on('disconnect', function() {
    ...
    if (onlineUsers.hasOwnProperty(socket.id)) {
      ...
      logger.info({ socketId: socket.id, ip: socket.request.connection.remoteAddress, user: obj.username, event: 'out', message: obj.username + 'exit'});
      console.log(obj.username + 'exit');
    }
  });
  ...
  socket.on('message', function(obj) {
    io.emit('message', obj);
    logger.info({ socketId: socket.id, ip: socket.request.connection.remoteAddress, user: obj.username, event: 'chat', message: obj.username + ':' + obj.message});
