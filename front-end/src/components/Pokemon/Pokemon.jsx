...
class Pokemon extends Component {
  ...
  render() {
    ...
    return (
      ...
      <h1 className={PokemonHeader}>Reviews</h1>
      {this.state.reviewsList}
      <br/>
      <br/>
      <br/>
      <h1 className={PokemonHeader}>The number of Reviews for Movies</h1>
      {this.state.group}
        <h1 className={PokemonHeader}>Let's Write a Review!</h1>
        <Input
        ...
        <br/>
        <br/>
          <h1 className={PokemonHeader}>Let's Search for a Review!</h1>
        <Input
        ...
        <h1 className={PokemonHeader}>Let's Get all Reviews from two Movies!</h1>
        <Input
